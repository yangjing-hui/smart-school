...
public class mybookscontroll extends AbstractListPlugin {
    ...
    public void beforeDoOperation(BeforeDoOperationEventArgs e) {
        ...
        if ( StringUtils.equals("returnbook", opKey)){
            ...
            DynamicObject chooseBook = BusinessDataServiceHelper.loadSingle("kxr1_bookshelf", "id,kxr1_basedatafield,billstatus,kxr1_timereturn", new QFilter[]{idFilter,userFilter});
            if(chooseBook.get("billstatus")=="C"){
